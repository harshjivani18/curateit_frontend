...
export function InsertImageUriDialogBody({
  ...
  return (
    <>
      ...
      <TextInput
        label="Image Link"
        placeholder="Put website like e.g. https://curateit.com"
        onChange={setImageLink}
        onBlur={onUpdateImageLink}
        value={imageLink}
        data-test-id="image-modal-link-input"
      />
      <DialogActions>
        <Button
    ...
    <>
      ...
      <DialogActions>
        <Button
          ...
          disabled={isDisabled}
          onClick={() => onClick({altText, src, imageLink})}>
          Confirm
        </Button>
      </DialogActions>
    </>
...
function onDrop(event, editor) {
  ...
  if (canDropImage(event)) {
    ...
    .then(response => {
      editor.dispatchCommand(INSERT_IMAGE_COMMAND, { src: response.message, altText: "", imageLink: "" });
    })
    .catch(error => {
