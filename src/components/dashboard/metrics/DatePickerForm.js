    ...
    <div className={styles.container}>
      <div className={styles.filter}>
        <ButtonGroup selectedKey={selected} onSelect={setSelected}>
          <Button key={FILTER_DAY}>Single day</Button>
          <Button key={FILTER_RANGE}>Date range</Button>
          {/* <Button key={FILTER_DAY}>{labels.singleDay}</Button>
          <Button key={FILTER_RANGE}>{labels.dateRange}</Button> */}
        </ButtonGroup>
      </div>
