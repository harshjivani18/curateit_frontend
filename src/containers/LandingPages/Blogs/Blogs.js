...
const Blogs = ({ title, subTitle, cta, blogs }) => {
          ...
          <>
            ...
            >
              ...
              <div className="mt-[20px] flex flex-row items-start justify-start lg:justify-between gap-4">
                <p className="text-[#062046] text-[20px] leading-[32px] font-medium md:font-semibold tracking-tight">
                  {blog?.title}
                </p>
                <p>
                  <PiArrowUpRightBold className="text-[#062046] text-[20px] leading-[32px] mt-2" />
                </p>
              </div>
  ...
  return (
    <div id="latest-blogs" className="w-full pt-10">
      <div className="page-layout flex flex-col items-center md:items-start gap-8 lg:gap-16">
        <div className="w-full flex flex-row items-start justify-center md:justify-between ">
          <div>
            <p className="text-center md:text-left text-[32px] text-[#062046] font-bold leading-[40px] md:text-[40px] md:font-semibold md:leading-[44px]">
              {title}
            </p>
            <p className="text-center md:text-left text-[16px] text-[#475467] leading-[22.4px] md:text-[20px] md:leading-[30px] mt-5">
              {subTitle}
            </p>
          </div>

          <button className="hidden lg:block bg-[#105FD3] py-3 px-8 lg:py-3 lg:px-5 rounded-[8px]">
            <a
