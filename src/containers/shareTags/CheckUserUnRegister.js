...
import { checkTagExpiration, clearAllTags, getSharedTags, resetSharedTags, updateUnRegisteredUserTag } from "@actions/tags"
...
const CheckUserUnRegister = () => {
    ...
    return(
        ...
        <main className='px-16 mt-[14px]'>
            ...
            <div>
                {/* <SocialLogin  /> */}
                <SocialLoginOptions page={`tag-mail`} email={emailId} tagId={tagId} tokenId={tokenId} isNew={true}/>
            </div>
